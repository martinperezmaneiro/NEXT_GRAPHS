...
from NEXT_graphNN.utils.blob_classification_utils import *
...
if __name__ == "__main__":
    ...
    for th in threshold:
        for dis in distances:
            ...
            start_time = time()
            eventInfo_pred = segmentation_blob_classification(orig_file, pred_file, th, nevents = nevents, max_distance = dis)[['dataset_id', 'binclass', 'pred_class']].drop_duplicates().reset_index()
